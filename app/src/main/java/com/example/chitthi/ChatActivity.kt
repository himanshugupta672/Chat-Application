...
class ChatActivity : AppCompatActivity() {
    ...
    private lateinit var messageList: ArrayList<com.example.chitthi.Message>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            .addValueEventListener(object: ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for(postSnapshot in snapshot.children){
                        val message = postSnapshot.getValue(com.example.chitthi.Message::class.java)
        ...
        sendButton.setOnClickListener {
            ...
            val messageObject = com.example.chitthi.Message(message,senderUid)
